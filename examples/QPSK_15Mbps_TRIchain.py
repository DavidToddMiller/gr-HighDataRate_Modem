...
class QPSK_15Mbps_TRIchain(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.limesdr_source_0.set_bandwidth(20000000, 0)
        self.limesdr_source_0.set_gain(40,0)
        self.limesdr_source_0.set_antenna(255,0)
        self.limesdr_source_0.set_processor_affinity([1])
        self.limesdr_source_0.set_min_output_buffer(280000)
        self.limesdr_sink_0 = limesdr.sink('', 0, '', '')
        self.limesdr_sink_0.set_sample_rate(samp_rate)
        self.limesdr_sink_0.set_center_freq(freq, 0)
        self.limesdr_sink_0.set_bandwidth(20000000,0)
        self.limesdr_sink_0.set_digital_filter(15000000,0)
        self.limesdr_sink_0.set_gain(25,0)
        self.limesdr_sink_0.set_antenna(255,0)
        self.limesdr_sink_0.calibrate(15000000, 0)
        self.limesdr_sink_0.set_processor_affinity([1])
        ...
        self.blocks_keep_m_in_n_0_0_0.set_min_output_buffer(164000)
        ...
        self.blocks_keep_m_in_n_0_0.set_min_output_buffer(164000)
        ...
        self.blocks_keep_m_in_n_0.set_min_output_buffer(164000)
        ...
        self.HighDataRate_Modem_Resolve_Phase_0 = HighDataRate_Modem.Resolve_Phase()
        self.HighDataRate_Modem_Resolve_Phase_0.set_processor_affinity([3])
        self.HighDataRate_Modem_Extract_Frame_0 = HighDataRate_Modem.Extract_Frame()
        self.HighDataRate_Modem_Extract_Frame_0.set_processor_affinity([3])
        ...
        self.connect((self.HighDataRate_Modem_Extract_Frame_0, 0), (self.HighDataRate_Modem_Resolve_Phase_0, 0))
        ...
        self.connect((self.HighDataRate_Modem_Tag_FrameASM_0, 0), (self.HighDataRate_Modem_Extract_Frame_0, 0))
        ...
        self.connect((self.blocks_file_source_0_0_0, 0), (self.limesdr_sink_0, 0))
        ...
        self.connect((self.limesdr_source_0, 0), (self.blocks_multiply_const_vxx_0, 0))
